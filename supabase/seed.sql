...
('Pharmacy',                'pharmacy',    'Medication dispensary',                       -18.97071, 32.65453, 'Block A, Ground Floor, near the main entrance and reception desk', 'Ground Floor', 'pharmacy'),
('Main Public Toilets',     'toilet',      'Public toilets close to the main entrance',  -18.97066, 32.65458, 'Walk in from the main entrance, keep left past reception, and the toilets are just there on the ground floor', 'Ground Floor', 'toilet'),
('OPD Toilets',             'toilet',      'Restrooms near the Outpatient Department',    -18.97049, 32.65486, 'From the main entrance, head straight toward OPD Block B and you will find the toilets on your right', 'Ground Floor', 'toilet'),
